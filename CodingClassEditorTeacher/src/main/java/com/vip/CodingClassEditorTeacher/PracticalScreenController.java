...
public class PracticalScreenController implements Initializable {
	...
	private void updateView() {
		// TODO Auto-generated method stub
		Call<List<Practical>> call = teacherService.getPracticalList(subjectClass.getSubId(), count);
	...
	public void onAddPractical() {
		try {
			FXMLLoader fxmlLoader = App.loadFXMLItems("addpractical");
			Parent parent = fxmlLoader.load();
			AddPracticalController practicalController = (AddPracticalController) fxmlLoader.getController();
